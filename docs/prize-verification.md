...
Because the application collects only minimal player information (Name, and Legajo/DNI) without a secure SSO login, the definitive verification of a player's identity and their right to claim a prize happens **physically** after the game.

## Policy
1. **Frontend Collection:** The player enters their Legajo or DNI at the start of the event. The application does **not** validate if the Legajo belongs to the actual person holding the phone; it only blocks the *same* Legajo from being used twice.
